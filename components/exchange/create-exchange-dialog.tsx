...
const exchangeIPs = {
  Binance: ["167.99.69.151"],
  Bitget: ["167.99.69.151", "148.135.103.68", "107.172.83.193"],
  Bybit: ["167.99.69.151"],
  OKX: ["167.99.69.151", "148.135.103.68", "107.172.83.193"],
  // Bitfinex: ["167.99.69.151", "148.135.103.68", "107.172.83.193"],
};
          ...
          <div className="mt-1 flex items-start">
            {selectedExchange === "" ? (
              ...
              <>
                ...
                <code className="max-h-20 overflow-x-auto break-all rounded border border-gray-300 bg-white px-2 py-1 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                  {displayIPs}
                </code>
